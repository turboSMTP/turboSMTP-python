...
conf = API_TurboSMTP.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://pro.api.serversmtp.com/api/v2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("API_TurboSMTP")
    ...
    def auth_settings(self):
        ...
        if 'consumerKey' in self.api_key:
            auth['consumerKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'consumerKey',
        ...
        if 'consumerSecret' in self.api_key:
            auth['consumerSecret'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'consumerSecret',
