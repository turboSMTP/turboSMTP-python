...
class MailApi:
    ...
    def send_email(
        self,
        email_request_body: EmailRequestBody,
        ...
        :param email_request_body: (required)
        :type email_request_body: EmailRequestBody
        ...
        _param = self._send_email_serialize(
            email_request_body=email_request_body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SendSucessResponsetBody",
            '400': "SendBadRequestResponseBody",
            '401': "SendUnauthorizedResponseBody",
        }
    ...
    def send_email_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[SendSucessResponsetBody]:
        """Send email message
    ...
    def _send_email_serialize(
        ...
        if email_request_body is not None:
            _body_params = email_request_body
