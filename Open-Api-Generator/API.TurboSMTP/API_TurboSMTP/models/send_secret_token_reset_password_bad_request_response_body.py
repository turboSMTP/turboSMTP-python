...
class SendSecretTokenResetPasswordBadRequestResponseBody(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['empty_request_body', 'missing_required_parameter_email']):
            raise ValueError("must be one of enum values ('empty_request_body', 'missing_required_parameter_email')")
        return value
