...
class SubaccountBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ip", "first_name", "last_name", "address_1", "address_2", "city", "company_name", "country", "region", "zip_code", "phone_number", "policy_agree", "site_url"]
