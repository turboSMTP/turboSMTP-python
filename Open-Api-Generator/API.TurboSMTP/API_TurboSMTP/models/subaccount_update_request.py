...
class SubaccountUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    ip: StrictStr = Field(description="IP address to use for sending emails.")
    first_name: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="subaccount owner first name")
    last_name: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="subaccount owner last name")
    ...
    policy_agree: StrictBool = Field(description="Policy must be agreed in order to be able to create a subaccount.")
    site_url: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=45)]] = Field(default=None, description="Website")
    password: Optional[Annotated[str, Field(min_length=10, strict=True)]] = Field(default=None, description="subaccount password")
    confirm_password: Optional[Annotated[str, Field(min_length=10, strict=True)]] = Field(default=None, description="subaccount confirm password")
    __properties: ClassVar[List[str]] = ["ip", "first_name", "last_name", "address_1", "address_2", "city", "company_name", "country", "region", "zip_code", "phone_number", "policy_agree", "site_url", "password", "confirm_password"]
