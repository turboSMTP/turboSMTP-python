...
class SuppressionUploadResponse(BaseModel):
    """
    SuppressionUploadResponse
    """ # noqa: E501
    status: Optional[StrictStr] = None
    valid: Optional[List[StrictStr]] = None
    invalid: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["status", "valid", "invalid"]
