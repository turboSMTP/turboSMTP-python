...
class EmailValidatorMailSharedDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "sub_status", "free_email", "domain", "domain_age_days", "smtp_provider", "mx_found", "mx_record"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailValidatorMailSharedDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailValidatorMailSharedDetails from a dict"""
        if obj is None:
            return None
