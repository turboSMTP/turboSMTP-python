...
class UpdateResetPasswordRequestBody(BaseModel):
    """
    UpdateResetPasswordRequestBody
    """ # noqa: E501
    password: StrictStr = Field(description="New Password to be used.")
    confirm_password: StrictStr = Field(description="New Password to be used.")
    token: StrictStr = Field(description="Reset Password Token")
    __properties: ClassVar[List[str]] = ["password", "confirm_password", "token"]
