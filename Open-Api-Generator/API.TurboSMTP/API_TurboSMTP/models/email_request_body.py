...
from API_TurboSMTP.models.list[attachment] import List[Attachment]
...
class EmailRequestBody(BaseModel):
    ...
    EmailRequestBody
    """ # noqa: E501
    authuser: Optional[StrictStr] = Field(default=None, description="email of turboSMTP account")
    authpass: Optional[StrictStr] = Field(default=None, description="password of turboSMTP account")
    ...
    __properties: ClassVar[List[str]] = ["authuser", "authpass", "from", "to", "subject", "cc", "bcc", "content", "html_content", "custom_headers", "reference_id", "X-campaign-ID", "mime_raw", "attachments"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if authuser (nullable) is None
        # and model_fields_set contains the field
        if self.authuser is None and "authuser" in self.model_fields_set:
            _dict['authuser'] = None

        # set to None if authpass (nullable) is None
        # and model_fields_set contains the field
        if self.authpass is None and "authpass" in self.model_fields_set:
            _dict['authpass'] = None
