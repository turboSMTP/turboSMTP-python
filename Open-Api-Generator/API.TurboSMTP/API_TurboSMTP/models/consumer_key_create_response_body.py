...
class ConsumerKeyCreateResponseBody(BaseModel):
    """
    ...
    consumer_secret: Optional[StrictStr] = Field(default=None, description="Consumer Secret", alias="consumerSecret")
    __properties: ClassVar[List[str]] = ["consumerKey", "consumerSecret"]
