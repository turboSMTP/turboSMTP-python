...
class EmailValidatorValidateListBadRequestResponseBody(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['list_already_validated', 'insufficient_credit']):
            raise ValueError("must be one of enum values ('list_already_validated', 'insufficient_credit')")
        return value
