...
class SubaccountCreateRequest(BaseModel):
    ...
    password: Annotated[str, Field(min_length=10, strict=True)] = Field(description="subaccount password")
    confirm_password: Annotated[str, Field(min_length=10, strict=True)] = Field(description="subaccount confirm password")
    __properties: ClassVar[List[str]] = ["email", "ip", "first_name", "last_name", "address_1", "address_2", "city", "company_name", "country", "region", "zip_code", "phone_number", "policy_agree", "site_url", "password", "confirm_password"]
