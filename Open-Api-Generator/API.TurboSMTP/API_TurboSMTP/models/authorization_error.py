...
class AuthorizationError(BaseModel):
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['missing_authorization_key', 'invalid_authorization_key']):
            raise ValueError("must be one of enum values ('missing_authorization_key', 'invalid_authorization_key')")
        return value
