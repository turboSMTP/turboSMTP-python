...
class CheckValidityTokenResetPasswordBadRequestResponseBody(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['forgot_password_token_is_missing']):
            raise ValueError("must be one of enum values ('forgot_password_token_is_missing')")
        return value
