...
class BuyEmailValidatorCreditsBadRequestResponseBody(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['missing_required_parameter_amount', 'amount_should_be_integer', 'amount_should_not_be_less_than_15', 'amount_should_not_be_higher_than_1800']):
            raise ValueError("must be one of enum values ('missing_required_parameter_amount', 'amount_should_be_integer', 'amount_should_not_be_less_than_15', 'amount_should_not_be_higher_than_1800')")
        return value
