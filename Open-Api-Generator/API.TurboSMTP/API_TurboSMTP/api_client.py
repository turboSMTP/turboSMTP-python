...
from API_TurboSMTP.api_response import ApiResponse, T as ApiResponseT
import API_TurboSMTP.models
from API_TurboSMTP import rest
from API_TurboSMTP.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(API_TurboSMTP.models, klass)
