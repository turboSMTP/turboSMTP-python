...
class TestEmailValidatorValidatedMailsResults(unittest.TestCase):
    """EmailValidatorValidatedMailsResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailValidatorValidatedMailsResults:
        """Test EmailValidatorValidatedMailsResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailValidatorValidatedMailsResults`
        """
        model = EmailValidatorValidatedMailsResults()
        if include_optional:
            return EmailValidatorValidatedMailsResults(
                count = 56,
                processed = 56,
                results = [
                    null
    ...
    def testEmailValidatorValidatedMailsResults(self):
        """Test EmailValidatorValidatedMailsResults"""
