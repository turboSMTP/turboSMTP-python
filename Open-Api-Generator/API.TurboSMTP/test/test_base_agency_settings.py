...
class TestBaseAgencySettings(unittest.TestCase):
    """BaseAgencySettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseAgencySettings:
        """Test BaseAgencySettings
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseAgencySettings`
        """
        model = BaseAgencySettings()
        if include_optional:
            return BaseAgencySettings(
    ...
    def testBaseAgencySettings(self):
        """Test BaseAgencySettings"""
