...
class TestSuppressionsSucessResponsetBody(unittest.TestCase):
    """SuppressionsSucessResponsetBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionsSucessResponsetBody:
        """Test SuppressionsSucessResponsetBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionsSucessResponsetBody`
        """
        model = SuppressionsSucessResponsetBody()
        if include_optional:
            return SuppressionsSucessResponsetBody(
                count = 56,
                results = [
                    API_TurboSMTP.models.suppression.Suppression(
    ...
    def testSuppressionsSucessResponsetBody(self):
        """Test SuppressionsSucessResponsetBody"""
