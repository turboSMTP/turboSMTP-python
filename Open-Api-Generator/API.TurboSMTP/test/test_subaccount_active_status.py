...
class TestSubaccountActiveStatus(unittest.TestCase):
    """SubaccountActiveStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubaccountActiveStatus:
        """Test SubaccountActiveStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubaccountActiveStatus`
        """
        model = SubaccountActiveStatus()
        if include_optional:
            return SubaccountActiveStatus(
                active = True
            )
        else:
            return SubaccountActiveStatus(
    ...
    def testSubaccountActiveStatus(self):
        """Test SubaccountActiveStatus"""
