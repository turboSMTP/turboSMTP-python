...
class TestEmailRequestBody(unittest.TestCase):
    """EmailRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailRequestBody:
        """Test EmailRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailRequestBody`
        """
        model = EmailRequestBody()
        if include_optional:
            return EmailRequestBody(
                ...
                mime_raw = '',
                attachments = [
                    API_TurboSMTP.models.attachment.attachment(
