...
class TestSubaccountSMTPLimit(unittest.TestCase):
    """SubaccountSMTPLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubaccountSMTPLimit:
        """Test SubaccountSMTPLimit
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubaccountSMTPLimit`
        """
        model = SubaccountSMTPLimit()
        if include_optional:
            return SubaccountSMTPLimit(
                limit = 2000
            )
        else:
            return SubaccountSMTPLimit(
    ...
    def testSubaccountSMTPLimit(self):
        """Test SubaccountSMTPLimit"""
