...
class TestUpdateResetPasswordBadRequestResponseBody(unittest.TestCase):
    """UpdateResetPasswordBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateResetPasswordBadRequestResponseBody:
        """Test UpdateResetPasswordBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateResetPasswordBadRequestResponseBody`
        """
        model = UpdateResetPasswordBadRequestResponseBody()
        if include_optional:
            return UpdateResetPasswordBadRequestResponseBody(
    ...
    def testUpdateResetPasswordBadRequestResponseBody(self):
        """Test UpdateResetPasswordBadRequestResponseBody"""
