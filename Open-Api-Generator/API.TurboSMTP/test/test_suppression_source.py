...
class TestSuppressionSource(unittest.TestCase):
    """SuppressionSource unit test stubs"""
    ...
    def testSuppressionSource(self):
        """Test SuppressionSource"""
        # inst = SuppressionSource()
