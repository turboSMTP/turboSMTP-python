...
class TestSubaccountIP(unittest.TestCase):
    """SubaccountIP unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubaccountIP:
        """Test SubaccountIP
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubaccountIP`
        """
        model = SubaccountIP()
        if include_optional:
            return SubaccountIP(
