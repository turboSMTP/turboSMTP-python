...
class TestConsumerKeyCreateResponseBody(unittest.TestCase):
    """ConsumerKeyCreateResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsumerKeyCreateResponseBody:
        """Test ConsumerKeyCreateResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsumerKeyCreateResponseBody`
        """
        model = ConsumerKeyCreateResponseBody()
        if include_optional:
            return ConsumerKeyCreateResponseBody(
                consumer_key = 'b914ad238d0e8e8851b81e86ce46ae1d',
                consumer_secret = 'JOSenWTYopGjhZ1CDvsEbcK9PNUA06Xy'
            )
        else:
            return ConsumerKeyCreateResponseBody(
        )
    ...
    def testConsumerKeyCreateResponseBody(self):
        """Test ConsumerKeyCreateResponseBody"""
