...
class TestCommmonResultResponseBody(unittest.TestCase):
    """CommmonResultResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommmonResultResponseBody:
        """Test CommmonResultResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommmonResultResponseBody`
        """
        model = CommmonResultResponseBody()
        if include_optional:
            return CommmonResultResponseBody(
                result = True
            )
        else:
            return CommmonResultResponseBody(
    ...
    def testCommmonResultResponseBody(self):
        """Test CommmonResultResponseBody"""
