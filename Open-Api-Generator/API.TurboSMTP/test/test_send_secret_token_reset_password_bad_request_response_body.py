...
class TestSendSecretTokenResetPasswordBadRequestResponseBody(unittest.TestCase):
    """SendSecretTokenResetPasswordBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSecretTokenResetPasswordBadRequestResponseBody:
        """Test SendSecretTokenResetPasswordBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSecretTokenResetPasswordBadRequestResponseBody`
        """
        model = SendSecretTokenResetPasswordBadRequestResponseBody()
        if include_optional:
            return SendSecretTokenResetPasswordBadRequestResponseBody(
    ...
    def testSendSecretTokenResetPasswordBadRequestResponseBody(self):
        """Test SendSecretTokenResetPasswordBadRequestResponseBody"""
