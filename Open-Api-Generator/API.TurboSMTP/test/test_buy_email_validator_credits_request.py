...
class TestBuyEmailValidatorCreditsRequest(unittest.TestCase):
    """BuyEmailValidatorCreditsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuyEmailValidatorCreditsRequest:
        """Test BuyEmailValidatorCreditsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuyEmailValidatorCreditsRequest`
        """
        model = BuyEmailValidatorCreditsRequest()
        if include_optional:
            return BuyEmailValidatorCreditsRequest(
                amount = 320
            )
        else:
            return BuyEmailValidatorCreditsRequest(
    ...
    def testBuyEmailValidatorCreditsRequest(self):
        """Test BuyEmailValidatorCreditsRequest"""
