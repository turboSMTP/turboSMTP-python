...
class TestSubaccountActivePlan(unittest.TestCase):
    """SubaccountActivePlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubaccountActivePlan:
        """Test SubaccountActivePlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubaccountActivePlan`
        """
        model = SubaccountActivePlan()
        if include_optional:
            return SubaccountActivePlan(
                ip = '185.228.36.19',
                active = True,
    ...
    def testSubaccountActivePlan(self):
        """Test SubaccountActivePlan"""
