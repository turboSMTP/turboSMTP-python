...
class TestEmailValidatorValidateBadRequestResponseBody(unittest.TestCase):
    """EmailValidatorValidateBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailValidatorValidateBadRequestResponseBody:
        """Test EmailValidatorValidateBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailValidatorValidateBadRequestResponseBody`
        """
        model = EmailValidatorValidateBadRequestResponseBody()
        if include_optional:
            return EmailValidatorValidateBadRequestResponseBody(
    ...
    def testEmailValidatorValidateBadRequestResponseBody(self):
        """Test EmailValidatorValidateBadRequestResponseBody"""
