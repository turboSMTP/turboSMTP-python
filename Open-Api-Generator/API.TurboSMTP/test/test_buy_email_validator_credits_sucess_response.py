...
class TestBuyEmailValidatorCreditsSucessResponse(unittest.TestCase):
    """BuyEmailValidatorCreditsSucessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuyEmailValidatorCreditsSucessResponse:
        """Test BuyEmailValidatorCreditsSucessResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuyEmailValidatorCreditsSucessResponse`
        """
        model = BuyEmailValidatorCreditsSucessResponse()
        if include_optional:
            return BuyEmailValidatorCreditsSucessResponse(
    ...
    def testBuyEmailValidatorCreditsSucessResponse(self):
        """Test BuyEmailValidatorCreditsSucessResponse"""
