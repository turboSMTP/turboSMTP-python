...
class TestEmailValidatorListEmailDetails(unittest.TestCase):
    """EmailValidatorListEmailDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailValidatorListEmailDetails:
        """Test EmailValidatorListEmailDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailValidatorListEmailDetails`
        """
        model = EmailValidatorListEmailDetails()
        if include_optional:
            return EmailValidatorListEmailDetails(
    ...
    def testEmailValidatorListEmailDetails(self):
        """Test EmailValidatorListEmailDetails"""
