...
class TestSendSucessResponsetBody(unittest.TestCase):
    """SendSucessResponsetBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSucessResponsetBody:
        """Test SendSucessResponsetBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSucessResponsetBody`
        """
        model = SendSucessResponsetBody()
        if include_optional:
            return SendSucessResponsetBody(
                message = 'OK',
    ...
    def testSendSucessResponsetBody(self):
        """Test SendSucessResponsetBody"""
