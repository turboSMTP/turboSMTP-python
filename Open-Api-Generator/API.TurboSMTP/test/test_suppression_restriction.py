...
class TestSuppressionRestriction(unittest.TestCase):
    """SuppressionRestriction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionRestriction:
        """Test SuppressionRestriction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionRestriction`
        """
        model = SuppressionRestriction()
        if include_optional:
    ...
    def testSuppressionRestriction(self):
        """Test SuppressionRestriction"""
