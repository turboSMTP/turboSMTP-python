...
class TestAuthenticationLoginSucessResponsetBody(unittest.TestCase):
    """AuthenticationLoginSucessResponsetBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticationLoginSucessResponsetBody:
        """Test AuthenticationLoginSucessResponsetBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationLoginSucessResponsetBody`
        """
        model = AuthenticationLoginSucessResponsetBody()
        if include_optional:
            return AuthenticationLoginSucessResponsetBody(
                auth = ''
            )
        else:
            return AuthenticationLoginSucessResponsetBody(
    ...
    def testAuthenticationLoginSucessResponsetBody(self):
        """Test AuthenticationLoginSucessResponsetBody"""
