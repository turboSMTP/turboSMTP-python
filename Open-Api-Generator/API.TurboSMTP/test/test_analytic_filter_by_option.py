...
class TestAnalyticFilterByOption(unittest.TestCase):
    """AnalyticFilterByOption unit test stubs"""
    ...
    def testAnalyticFilterByOption(self):
        """Test AnalyticFilterByOption"""
        # inst = AnalyticFilterByOption()
