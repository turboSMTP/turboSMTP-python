...
class TestConsumerKeyListSucessResponsetBody(unittest.TestCase):
    """ConsumerKeyListSucessResponsetBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsumerKeyListSucessResponsetBody:
        """Test ConsumerKeyListSucessResponsetBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsumerKeyListSucessResponsetBody`
        """
        model = ConsumerKeyListSucessResponsetBody()
        if include_optional:
            return ConsumerKeyListSucessResponsetBody(
                count = 56,
                results = [
                    API_TurboSMTP.models.consumer_key.ConsumerKey(
                        consumer_key = 'b914ad238d0e8e8851b81e86ce46ae1d', 
                        label = 'QAkey.', 
    ...
    def testConsumerKeyListSucessResponsetBody(self):
        """Test ConsumerKeyListSucessResponsetBody"""
