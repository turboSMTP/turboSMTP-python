...
class TestChangePasswordRequestBody(unittest.TestCase):
    """ChangePasswordRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangePasswordRequestBody:
        """Test ChangePasswordRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangePasswordRequestBody`
        """
        model = ChangePasswordRequestBody()
        if include_optional:
    ...
    def testChangePasswordRequestBody(self):
        """Test ChangePasswordRequestBody"""
