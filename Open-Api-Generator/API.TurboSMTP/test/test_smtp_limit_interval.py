...
class TestSmtpLimitInterval(unittest.TestCase):
    """SmtpLimitInterval unit test stubs"""
    ...
    def testSmtpLimitInterval(self):
        """Test SmtpLimitInterval"""
        # inst = SmtpLimitInterval()
