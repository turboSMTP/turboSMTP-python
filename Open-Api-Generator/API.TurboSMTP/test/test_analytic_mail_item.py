...
class TestAnalyticMailItem(unittest.TestCase):
    """AnalyticMailItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyticMailItem:
        """Test AnalyticMailItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyticMailItem`
        """
        model = AnalyticMailItem()
        if include_optional:
            return AnalyticMailItem(
