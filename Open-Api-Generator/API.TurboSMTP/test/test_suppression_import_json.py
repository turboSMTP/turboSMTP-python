...
class TestSuppressionImportJson(unittest.TestCase):
    """SuppressionImportJson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionImportJson:
        """Test SuppressionImportJson
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionImportJson`
        """
        model = SuppressionImportJson()
        if include_optional:
            return SuppressionImportJson(
                type = 'manual',
                reason = '',
                content = [
                    ''
    ...
    def testSuppressionImportJson(self):
        """Test SuppressionImportJson"""
