...
class TestSubaccountPlanBase(unittest.TestCase):
    """SubaccountPlanBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubaccountPlanBase:
        """Test SubaccountPlanBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubaccountPlanBase`
        """
        model = SubaccountPlanBase()
        if include_optional:
            return SubaccountPlanBase(
                limit = 2000,
                sent = 125,
                last_used = '2021-03-17 00:00:00',
    ...
    def testSubaccountPlanBase(self):
        """Test SubaccountPlanBase"""
