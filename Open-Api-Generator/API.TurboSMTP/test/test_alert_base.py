...
class TestAlertBase(unittest.TestCase):
    """AlertBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertBase:
        """Test AlertBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertBase`
        """
        model = AlertBase()
        if include_optional:
            return AlertBase(
