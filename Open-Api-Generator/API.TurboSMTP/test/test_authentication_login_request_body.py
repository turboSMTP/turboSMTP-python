...
class TestAuthenticationLoginRequestBody(unittest.TestCase):
    """AuthenticationLoginRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticationLoginRequestBody:
        """Test AuthenticationLoginRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationLoginRequestBody`
        """
        model = AuthenticationLoginRequestBody()
        if include_optional:
    ...
    def testAuthenticationLoginRequestBody(self):
        """Test AuthenticationLoginRequestBody"""
