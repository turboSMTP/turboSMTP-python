...
class TestSuppressionUploadResponse(unittest.TestCase):
    """SuppressionUploadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionUploadResponse:
        """Test SuppressionUploadResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionUploadResponse`
        """
        model = SuppressionUploadResponse()
        if include_optional:
            return SuppressionUploadResponse(
                status = '',
                valid = [
                    'username@gmail.com'
                    ],
    ...
    def testSuppressionUploadResponse(self):
        """Test SuppressionUploadResponse"""
