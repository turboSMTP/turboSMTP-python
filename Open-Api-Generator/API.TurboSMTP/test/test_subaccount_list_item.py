...
class TestSubaccountListItem(unittest.TestCase):
    """SubaccountListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubaccountListItem:
        """Test SubaccountListItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubaccountListItem`
        """
        model = SubaccountListItem()
        if include_optional:
    ...
    def testSubaccountListItem(self):
        """Test SubaccountListItem"""
