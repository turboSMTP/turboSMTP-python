...
class TestSubaccountPasswordConfirmPassword(unittest.TestCase):
    """SubaccountPasswordConfirmPassword unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubaccountPasswordConfirmPassword:
        """Test SubaccountPasswordConfirmPassword
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubaccountPasswordConfirmPassword`
        """
        model = SubaccountPasswordConfirmPassword()
        if include_optional:
            return SubaccountPasswordConfirmPassword(
                password = 'LetmeIn123!',
    ...
    def testSubaccountPasswordConfirmPassword(self):
        """Test SubaccountPasswordConfirmPassword"""
