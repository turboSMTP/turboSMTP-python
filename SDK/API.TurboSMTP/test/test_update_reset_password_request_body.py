...
class TestUpdateResetPasswordRequestBody(unittest.TestCase):
    """UpdateResetPasswordRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateResetPasswordRequestBody:
        """Test UpdateResetPasswordRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateResetPasswordRequestBody`
        """
        model = UpdateResetPasswordRequestBody()
        if include_optional:
            return UpdateResetPasswordRequestBody(
                password = '',
                confirm_password = '',
                token = ''
            )
    ...
    def testUpdateResetPasswordRequestBody(self):
        """Test UpdateResetPasswordRequestBody"""
