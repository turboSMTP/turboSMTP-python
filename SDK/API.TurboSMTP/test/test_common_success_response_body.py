...
class TestCommonSuccessResponseBody(unittest.TestCase):
    """CommonSuccessResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommonSuccessResponseBody:
        """Test CommonSuccessResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommonSuccessResponseBody`
        """
        model = CommonSuccessResponseBody()
        if include_optional:
            return CommonSuccessResponseBody(
                message = 'success'
            )
        else:
            return CommonSuccessResponseBody(
    ...
    def testCommonSuccessResponseBody(self):
        """Test CommonSuccessResponseBody"""
