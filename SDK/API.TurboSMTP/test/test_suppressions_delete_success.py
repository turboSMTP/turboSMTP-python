...
class TestSuppressionsDeleteSuccess(unittest.TestCase):
    """SuppressionsDeleteSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionsDeleteSuccess:
        """Test SuppressionsDeleteSuccess
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionsDeleteSuccess`
        """
        model = SuppressionsDeleteSuccess()
        if include_optional:
            return SuppressionsDeleteSuccess(
                success = True
            )
        else:
            return SuppressionsDeleteSuccess(
    ...
    def testSuppressionsDeleteSuccess(self):
        """Test SuppressionsDeleteSuccess"""
