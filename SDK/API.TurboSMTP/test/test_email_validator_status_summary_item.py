...
class TestEmailValidatorStatusSummaryItem(unittest.TestCase):
    """EmailValidatorStatusSummaryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailValidatorStatusSummaryItem:
        """Test EmailValidatorStatusSummaryItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailValidatorStatusSummaryItem`
        """
        model = EmailValidatorStatusSummaryItem()
        if include_optional:
            return EmailValidatorStatusSummaryItem(
                status = 'valid',
                total = 12
            )
        else:
    ...
    def testEmailValidatorStatusSummaryItem(self):
        """Test EmailValidatorStatusSummaryItem"""
