...
class TestAnalyticFilterBy(unittest.TestCase):
    """AnalyticFilterBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyticFilterBy:
        """Test AnalyticFilterBy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyticFilterBy`
        """
        model = AnalyticFilterBy()
        if include_optional:
            return AnalyticFilterBy(
            )
        else:
            return AnalyticFilterBy(
        )
