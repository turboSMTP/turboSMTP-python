...
class TestSuppressionFilterBy(unittest.TestCase):
    """SuppressionFilterBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionFilterBy:
        """Test SuppressionFilterBy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionFilterBy`
        """
        model = SuppressionFilterBy()
        if include_optional:
            return SuppressionFilterBy(
            )
        else:
            return SuppressionFilterBy(
        )
    ...
    def testSuppressionFilterBy(self):
        """Test SuppressionFilterBy"""
