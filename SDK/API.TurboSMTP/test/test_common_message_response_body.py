...
class TestCommonMessageResponseBody(unittest.TestCase):
    """CommonMessageResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommonMessageResponseBody:
        """Test CommonMessageResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommonMessageResponseBody`
        """
        model = CommonMessageResponseBody()
        if include_optional:
            return CommonMessageResponseBody(
                message = ''
            )
        else:
            return CommonMessageResponseBody(
    ...
    def testCommonMessageResponseBody(self):
        """Test CommonMessageResponseBody"""
