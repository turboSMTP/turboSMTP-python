...
class TestSendBadRequestResponseBody(unittest.TestCase):
    """SendBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendBadRequestResponseBody:
        """Test SendBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBadRequestResponseBody`
        """
        model = SendBadRequestResponseBody()
        if include_optional:
            return SendBadRequestResponseBody(
                message = 'error',
    ...
    def testSendBadRequestResponseBody(self):
        """Test SendBadRequestResponseBody"""
