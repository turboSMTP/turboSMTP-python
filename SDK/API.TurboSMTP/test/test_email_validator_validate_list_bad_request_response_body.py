...
class TestEmailValidatorValidateListBadRequestResponseBody(unittest.TestCase):
    """EmailValidatorValidateListBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailValidatorValidateListBadRequestResponseBody:
        """Test EmailValidatorValidateListBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailValidatorValidateListBadRequestResponseBody`
        """
        model = EmailValidatorValidateListBadRequestResponseBody()
        if include_optional:
            return EmailValidatorValidateListBadRequestResponseBody(
    ...
    def testEmailValidatorValidateListBadRequestResponseBody(self):
        """Test EmailValidatorValidateListBadRequestResponseBody"""
