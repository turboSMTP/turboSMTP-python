...
class TestEmailAddressRequestBody(unittest.TestCase):
    """EmailAddressRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailAddressRequestBody:
        """Test EmailAddressRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailAddressRequestBody`
        """
        model = EmailAddressRequestBody()
        if include_optional:
            return EmailAddressRequestBody(
    ...
    def testEmailAddressRequestBody(self):
        """Test EmailAddressRequestBody"""
