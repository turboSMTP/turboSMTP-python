...
class TestEmailValidatorListDeleteSuccess(unittest.TestCase):
    """EmailValidatorListDeleteSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailValidatorListDeleteSuccess:
        """Test EmailValidatorListDeleteSuccess
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailValidatorListDeleteSuccess`
        """
        model = EmailValidatorListDeleteSuccess()
        if include_optional:
            return EmailValidatorListDeleteSuccess(
                success = True
            )
        else:
            return EmailValidatorListDeleteSuccess(
    ...
    def testEmailValidatorListDeleteSuccess(self):
        """Test EmailValidatorListDeleteSuccess"""
