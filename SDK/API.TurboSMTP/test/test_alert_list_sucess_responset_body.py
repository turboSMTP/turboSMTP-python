...
class TestAlertListSucessResponsetBody(unittest.TestCase):
    """AlertListSucessResponsetBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertListSucessResponsetBody:
        """Test AlertListSucessResponsetBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertListSucessResponsetBody`
        """
        model = AlertListSucessResponsetBody()
        if include_optional:
            return AlertListSucessResponsetBody(
                count = 56,
                results = [
                    null
                    ]
    ...
    def testAlertListSucessResponsetBody(self):
        """Test AlertListSucessResponsetBody"""
