...
class TestSendUnauthorizedResponseBody(unittest.TestCase):
    """SendUnauthorizedResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendUnauthorizedResponseBody:
        """Test SendUnauthorizedResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendUnauthorizedResponseBody`
        """
        model = SendUnauthorizedResponseBody()
        if include_optional:
            return SendUnauthorizedResponseBody(
                error_code = 3,
    ...
    def testSendUnauthorizedResponseBody(self):
        """Test SendUnauthorizedResponseBody"""
