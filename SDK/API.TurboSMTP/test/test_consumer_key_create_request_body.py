...
class TestConsumerKeyCreateRequestBody(unittest.TestCase):
    """ConsumerKeyCreateRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsumerKeyCreateRequestBody:
        """Test ConsumerKeyCreateRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsumerKeyCreateRequestBody`
        """
        model = ConsumerKeyCreateRequestBody()
        if include_optional:
            return ConsumerKeyCreateRequestBody(
                label = 'QAkey.'
            )
        else:
            return ConsumerKeyCreateRequestBody(
    ...
    def testConsumerKeyCreateRequestBody(self):
        """Test ConsumerKeyCreateRequestBody"""
