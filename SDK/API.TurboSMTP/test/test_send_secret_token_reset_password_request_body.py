...
class TestSendSecretTokenResetPasswordRequestBody(unittest.TestCase):
    """SendSecretTokenResetPasswordRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSecretTokenResetPasswordRequestBody:
        """Test SendSecretTokenResetPasswordRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSecretTokenResetPasswordRequestBody`
        """
        model = SendSecretTokenResetPasswordRequestBody()
        if include_optional:
            return SendSecretTokenResetPasswordRequestBody(
    ...
    def testSendSecretTokenResetPasswordRequestBody(self):
        """Test SendSecretTokenResetPasswordRequestBody"""
