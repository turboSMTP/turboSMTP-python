...
class TestEmailValidatorList(unittest.TestCase):
    """EmailValidatorList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailValidatorList:
        """Test EmailValidatorList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailValidatorList`
        """
        model = EmailValidatorList()
        if include_optional:
            return EmailValidatorList(
                id = 2406,
    ...
    def testEmailValidatorList(self):
        """Test EmailValidatorList"""
