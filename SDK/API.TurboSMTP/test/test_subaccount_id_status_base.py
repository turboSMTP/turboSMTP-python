...
class TestSubaccountIDStatusBase(unittest.TestCase):
    """SubaccountIDStatusBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubaccountIDStatusBase:
        """Test SubaccountIDStatusBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubaccountIDStatusBase`
        """
        model = SubaccountIDStatusBase()
        if include_optional:
            return SubaccountIDStatusBase(
                ip = '185.228.36.19',
                active = True,
    ...
    def testSubaccountIDStatusBase(self):
        """Test SubaccountIDStatusBase"""
