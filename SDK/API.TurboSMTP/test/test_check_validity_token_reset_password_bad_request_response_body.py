...
class TestCheckValidityTokenResetPasswordBadRequestResponseBody(unittest.TestCase):
    """CheckValidityTokenResetPasswordBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckValidityTokenResetPasswordBadRequestResponseBody:
        """Test CheckValidityTokenResetPasswordBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckValidityTokenResetPasswordBadRequestResponseBody`
        """
        model = CheckValidityTokenResetPasswordBadRequestResponseBody()
        if include_optional:
            return CheckValidityTokenResetPasswordBadRequestResponseBody(
    ...
    def testCheckValidityTokenResetPasswordBadRequestResponseBody(self):
        """Test CheckValidityTokenResetPasswordBadRequestResponseBody"""
