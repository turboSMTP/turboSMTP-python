...
class TestSubAccountListSucessResponsetBody(unittest.TestCase):
    """SubAccountListSucessResponsetBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubAccountListSucessResponsetBody:
        """Test SubAccountListSucessResponsetBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubAccountListSucessResponsetBody`
        """
        model = SubAccountListSucessResponsetBody()
        if include_optional:
            return SubAccountListSucessResponsetBody(
                count = 56,
                results = [
                    null
                    ]
    ...
    def testSubAccountListSucessResponsetBody(self):
        """Test SubAccountListSucessResponsetBody"""
