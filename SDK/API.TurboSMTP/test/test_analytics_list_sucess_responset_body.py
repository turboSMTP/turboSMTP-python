...
class TestAnalyticsListSucessResponsetBody(unittest.TestCase):
    """AnalyticsListSucessResponsetBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyticsListSucessResponsetBody:
        """Test AnalyticsListSucessResponsetBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyticsListSucessResponsetBody`
        """
        model = AnalyticsListSucessResponsetBody()
        if include_optional:
            return AnalyticsListSucessResponsetBody(
                count = 56,
                results = [
                    API_TurboSMTP.models.analytic_mail_item.AnalyticMailItem(
    ...
    def testAnalyticsListSucessResponsetBody(self):
        """Test AnalyticsListSucessResponsetBody"""
