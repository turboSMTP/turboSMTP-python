...
class TestSuppressionUploadBadRequestResponseBody(unittest.TestCase):
    """SuppressionUploadBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionUploadBadRequestResponseBody:
        """Test SuppressionUploadBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionUploadBadRequestResponseBody`
        """
        model = SuppressionUploadBadRequestResponseBody()
        if include_optional:
            return SuppressionUploadBadRequestResponseBody(
                res = ''
            )
        else:
            return SuppressionUploadBadRequestResponseBody(
    ...
    def testSuppressionUploadBadRequestResponseBody(self):
        """Test SuppressionUploadBadRequestResponseBody"""
