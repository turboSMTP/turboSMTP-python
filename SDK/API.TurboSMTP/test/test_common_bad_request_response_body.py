...
class TestCommonBadRequestResponseBody(unittest.TestCase):
    """CommonBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommonBadRequestResponseBody:
        """Test CommonBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommonBadRequestResponseBody`
        """
        model = CommonBadRequestResponseBody()
        if include_optional:
            return CommonBadRequestResponseBody(
    ...
    def testCommonBadRequestResponseBody(self):
        """Test CommonBadRequestResponseBody"""
