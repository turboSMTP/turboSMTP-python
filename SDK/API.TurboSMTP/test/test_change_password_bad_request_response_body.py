...
class TestChangePasswordBadRequestResponseBody(unittest.TestCase):
    """ChangePasswordBadRequestResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangePasswordBadRequestResponseBody:
        """Test ChangePasswordBadRequestResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangePasswordBadRequestResponseBody`
        """
        model = ChangePasswordBadRequestResponseBody()
        if include_optional:
            return ChangePasswordBadRequestResponseBody(
    ...
    def testChangePasswordBadRequestResponseBody(self):
        """Test ChangePasswordBadRequestResponseBody"""
