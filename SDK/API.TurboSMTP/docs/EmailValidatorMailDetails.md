...
**account** | **str** | The portion of the email address before the \&quot;@\&quot; symbol. | [optional] 
**firstname** | **str** | The first name of the owner of the email when available or [null]. | [optional] 
**lastname** | **str** | The last name of the owner of the email when available or [null]. | [optional] 
**gender** | **str** | The gender of the owner of the email when available or [null]. | [optional] 
**country** | **str** | The country of the IP passed in or [null] | [optional] 
**region** | **str** | The region/state of the IP passed in or [null] | [optional] 
**city** | **str** | The city of the IP passed in or [null] | [optional] 
**zipcode** | **int** | The zipcode of the IP passed in or [null] | [optional] 
**processed_at** | **str** | The date time the email was validated. | [optional] 
...
json = "{}"
# create an instance of EmailValidatorMailDetails from a JSON string
email_validator_mail_details_instance = EmailValidatorMailDetails.from_json(json)
# print the JSON string representation of the object
print EmailValidatorMailDetails.to_json()

# convert the object into a dict
email_validator_mail_details_dict = email_validator_mail_details_instance.to_dict()
# create an instance of EmailValidatorMailDetails from a dict
email_validator_mail_details_form_dict = email_validator_mail_details.from_dict(email_validator_mail_details_dict)
```
