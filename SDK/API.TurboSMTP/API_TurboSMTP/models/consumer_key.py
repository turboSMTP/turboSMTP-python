...
class ConsumerKey(BaseModel):
    ...
    label: Optional[StrictStr] = Field(default=None, description="Consumer Key label.")
    creation_time: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The time the consumer key was created.")
    __properties: ClassVar[List[str]] = ["consumerKey", "label", "creation_time"]
