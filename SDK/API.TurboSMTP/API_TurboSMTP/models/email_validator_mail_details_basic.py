...
class EmailValidatorMailDetailsBasic(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="the id of the email address")
    __properties: ClassVar[List[str]] = ["email", "status", "sub_status", "free_email", "domain", "domain_age_days", "smtp_provider", "mx_found", "mx_record", "id"]
