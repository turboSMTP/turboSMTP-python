...
class EmailValidatorUploadBadRequestResponseBody(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['missing_upload_file,invalid_mail_address_list']):
            raise ValueError("must be one of enum values ('missing_upload_file,invalid_mail_address_list')")
        return value
