...
class SendSucessResponsetBody(BaseModel):
    """
    SendSucessResponsetBody
    """ # noqa: E501
    message: Optional[StrictStr] = None
    mid: Optional[Annotated[int, Field(le=8446744073709551617, strict=True, ge=0)]] = Field(default=None, description="message ID")
    __properties: ClassVar[List[str]] = ["message", "mid"]
