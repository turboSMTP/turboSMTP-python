...
class EmailValidationUploadResponse(BaseModel):
    """
    EmailValidationUploadResponse
    """ # noqa: E501
    list_id: Optional[StrictInt] = Field(default=None, description="List Identifier")
    total_emails: Optional[StrictInt] = Field(default=None, description="Total emails found in uploaded file")
    __properties: ClassVar[List[str]] = ["list_id", "total_emails"]
