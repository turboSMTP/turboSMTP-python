...
class Alert(BaseModel):
    ...
    """ # noqa: E501
    email: StrictStr
    percentage: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(default=None, description="Percentage of usage that will trigger the alert")
    id: Optional[StrictInt] = Field(default=None, description="Alert Id.")
    __properties: ClassVar[List[str]] = ["email", "percentage", "id"]
