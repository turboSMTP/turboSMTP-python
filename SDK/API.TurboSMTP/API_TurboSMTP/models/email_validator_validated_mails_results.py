...
class EmailValidatorValidatedMailsResults(BaseModel):
    """
    EmailValidatorValidatedMailsResults
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Count of vaidated email addresses in the list.")
    processed: Optional[StrictInt] = Field(default=None, description="Number of processed email addresses in the list.")
    results: Optional[List[EmailValidatorMailDetailsBasic]] = Field(default=None, description="Array of validated email addresses in the list.")
    __properties: ClassVar[List[str]] = ["count", "processed", "results"]
