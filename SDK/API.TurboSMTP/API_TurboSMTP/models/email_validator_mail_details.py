...
class EmailValidatorMailDetails(BaseModel):
    """
    ...
    account: Optional[StrictStr] = Field(default=None, description="The portion of the email address before the \"@\" symbol.")
    firstname: Optional[StrictStr] = Field(default=None, description="The first name of the owner of the email when available or [null].")
    lastname: Optional[StrictStr] = Field(default=None, description="The last name of the owner of the email when available or [null].")
    gender: Optional[StrictStr] = Field(default=None, description="The gender of the owner of the email when available or [null].")
    country: Optional[StrictStr] = Field(default=None, description="The country of the IP passed in or [null]")
    region: Optional[StrictStr] = Field(default=None, description="The region/state of the IP passed in or [null]")
    city: Optional[StrictStr] = Field(default=None, description="The city of the IP passed in or [null]")
    zipcode: Optional[StrictInt] = Field(default=None, description="The zipcode of the IP passed in or [null]")
    processed_at: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The date time the email was validated.")
    __properties: ClassVar[List[str]] = ["email", "status", "sub_status", "free_email", "domain", "domain_age_days", "smtp_provider", "mx_found", "mx_record", "did_you_mean", "account", "firstname", "lastname", "gender", "country", "region", "city", "zipcode", "processed_at"]
