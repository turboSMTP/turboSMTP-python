...
class BaseAgencySettings(BaseModel):
    """
    BaseAgencySettings
    """ # noqa: E501
    agency_name: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Agency Name")
    agency_website: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Agency Website")
    agency_footer: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(default=None, description="Footer to be used")
    __properties: ClassVar[List[str]] = ["agency_name", "agency_website", "agency_footer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "agency_website": obj.get("agency_website"),
            "agency_footer": obj.get("agency_footer")
        })
        return _obj
