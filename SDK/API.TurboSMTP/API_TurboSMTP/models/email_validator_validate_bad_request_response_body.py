...
class EmailValidatorValidateBadRequestResponseBody(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['invalid_mail_address', 'missing_required_parameter_email']):
            raise ValueError("must be one of enum values ('invalid_mail_address', 'missing_required_parameter_email')")
        return value
