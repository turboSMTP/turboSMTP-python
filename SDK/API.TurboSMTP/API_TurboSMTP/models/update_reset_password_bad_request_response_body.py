...
class UpdateResetPasswordBadRequestResponseBody(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['empty_request_body', 'password_is_missing', 'confirm_password_is_missing', 'current_password_is_missing', 'current_password_can_not_be_empty', 'password_should_equal_confirm_password', 'new_password_should_not_equal_current_password']):
            raise ValueError("must be one of enum values ('empty_request_body', 'password_is_missing', 'confirm_password_is_missing', 'current_password_is_missing', 'current_password_can_not_be_empty', 'password_should_equal_confirm_password', 'new_password_should_not_equal_current_password')")
        return value
