...
class Attachment(BaseModel):
    ...
    Attachment
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="Base64 encoded content of the attachment")
    name: Optional[StrictStr] = Field(default=None, description="filename of the attachment")
    type: Optional[StrictStr] = Field(default=None, description="mime type of the content you are attaching")
