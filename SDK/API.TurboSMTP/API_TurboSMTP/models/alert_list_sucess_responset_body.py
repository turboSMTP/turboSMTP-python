...
class AlertListSucessResponsetBody(BaseModel):
    """
    AlertListSucessResponsetBody
    """ # noqa: E501
    count: Optional[StrictInt] = None
    results: Optional[List[Alert]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "results": [Alert.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
