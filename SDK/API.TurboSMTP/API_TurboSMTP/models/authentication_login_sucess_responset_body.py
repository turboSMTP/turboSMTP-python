...
class AuthenticationLoginSucessResponsetBody(BaseModel):
    """
    AuthenticationLoginSucessResponsetBody
    """ # noqa: E501
    auth: Optional[StrictStr] = Field(default=None, description="API Key to be used in authorization header")
