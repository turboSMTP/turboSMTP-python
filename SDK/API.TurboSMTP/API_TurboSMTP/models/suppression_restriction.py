...
class SuppressionRestriction(BaseModel):
    """
    Restriction
    """ # noqa: E501
    by: Optional[SuppressionRestrictBy] = None
    operator: Optional[SuppressionOperator] = None
    filter: Optional[StrictStr] = None
    smart_search: Optional[StrictBool] = Field(default=False, description="Smart search")
    __properties: ClassVar[List[str]] = ["by", "operator", "filter", "smart_search"]
